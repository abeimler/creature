...
void InitData::makeCreature1() {
    ...
    makeDataCreature("Betamon", "Amphibian", DataCreatureEvol::Normal,
                     ...
                     DataCreatureAttribute::Virus, data::CreatureLevel::Child,
                     20, 1.0f);
    ...
    makeDataCreature("Tyranomon", "Dinosaur", DataCreatureEvol::Normal,
                     ...
                     DataCreatureAttribute::Data, data::CreatureLevel::Adult,
                     20, 10.8f);
    ...
    makeDataCreature(
        "Airdramon", "Mythical Beast", DataCreatureEvol::Bad,
        DataCreatureClass::Thief, {"Nature Spirits", "Wind Guardians"},
        DataCreatureAttribute::Vaccine, data::CreatureLevel::Adult, 20, 8.f);
    ...
    makeDataCreature(
        "Numemon", "Mollusk", DataCreatureEvol::BadMiss,
        DataCreatureClass::Normal, {"Metal Empire", "Nightmare Soldiers"},
        DataCreatureAttribute::Data, data::CreatureLevel::Adult, 10, 0.8f);
    ...
    makeDataCreature(
        "Mamemon", "Mutant", DataCreatureEvol::Normal,
        DataCreatureClass::WarriorThief, {"Metal Empire", "Virus Busters"},
    ...
    makeDataCreature(
        "BlackWargreymon", "Dragon Man", DataCreatureEvol::Good,
        DataCreatureClass::Warrior, {"Dragons Roar", "Metal Empire"},
        DataCreatureAttribute::Virus, data::CreatureLevel::Ultimate, 20, 2.0f);
}
...
void InitData::updateCreature1() {
    ...
    updateEvolution("Betamon", {"Seadramon", "Airdramon", "Meramon", "Devimon"},
                    {"Numemon"});
