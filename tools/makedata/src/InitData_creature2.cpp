...
void InitData::makeCreature2() {
    makeDataCreature("DigiTama02", "Digitama", datamaker::DataCreatureEvol::Normal,
    ...
    makeDataCreature("Gabumon", "Reptile", DataCreatureEvol::Normal,
                     DataCreatureClass::Starter,
                     { "Metal Empire", "Nature Spirits" },
                     DataCreatureAttribute::Vaccine,
                     data::CreatureLevel::Child, 20, 1.2f);

    makeDataCreature("Elecmon", "Mammal", DataCreatureEvol::Normal,
                     DataCreatureClass::Normal,
                     { "Deep Savers", "Nature Spirits" },
    ...
    makeDataCreature("Kabuterimon", "Insect", DataCreatureEvol::Normal,
                     ...
                     DataCreatureAttribute::Vaccine,
                     data::CreatureLevel::Adult, 30, 10.0f);

    makeDataCreature("Garurumon", "Beast", DataCreatureEvol::Good,
                     DataCreatureClass::Hunter,
                     { "Metal Empire", "Nature Spirits", "Nightmare Soldiers" },
                     DataCreatureAttribute::Data,
                     data::CreatureLevel::Adult, 20, 6.0f);

    makeDataCreature("Garurumon (Black)", "Beast", DataCreatureEvol::Good,
                     DataCreatureClass::Hunter,
    ...
    makeDataCreature("Yukidarumon", "Icy Snow", DataCreatureEvol::Normal,
                     ...
                     DataCreatureAttribute::Vaccine,
                     data::CreatureLevel::Adult, 30, 2.0f);

    makeDataCreature("Birdramon", "Giant Bird", DataCreatureEvol::Normal,
                     DataCreatureClass::Knight,
                     { "Nature Spirits", "Wind Guardians" },
                     DataCreatureAttribute::Data,
                     data::CreatureLevel::Adult, 30, 6.0f);

    makeDataCreature("Whamon", "Aquatic", DataCreatureEvol::Normal,
                     DataCreatureClass::Mage, { "Deep Savers" },
                     DataCreatureAttribute::Vaccine,
                     data::CreatureLevel::Adult, 50, 30.0f);
    ...
    makeDataCreature("Vegimon", "Plant", DataCreatureEvol::BadMiss,
                     ...
                     DataCreatureAttribute::Virus,
                     data::CreatureLevel::Adult, 10, 1.0f);
    ...
    makeDataCreature("Vademon", "Alien", DataCreatureEvol::Bad,
                     ...
                     DataCreatureAttribute::Virus,
                     data::CreatureLevel::Perfect, 20, 1.6f);



    makeDataCreature("MetalMamemon", "Cyborg", DataCreatureEvol::Normal,
                     DataCreatureClass::Knight,
    ...
    makeDataCreature("WereGarurumon (Black)", "Beast Man",
                     DataCreatureEvol::Good, DataCreatureClass::Hunter,
                     { "Nature Spirits", "Nightmare Soldiers" },
                     DataCreatureAttribute::Virus,
                     data::CreatureLevel::Perfect, 16, 1.8f);
...
void InitData::updateCreature2() {
    ...
    updateEvolution("Garurumon", { "WereGarurumon", "WereGarurumon (Black)",
                                   "MetalMamemon" });
