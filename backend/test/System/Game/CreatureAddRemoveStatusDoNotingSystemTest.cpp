...
class CreatureAddRemoveStatusDoNotingSystemApplication
    ...
    GIVEN("Creature Entity") {
      ...
      WHEN("emit addStatus-Event RunAway") {
        ...
        WHEN("emit addStatus-Event InHospital") {
            app.emit_event<gameevent::CreatureAddStatusEvent>(
                entity, data::CreatureStatus::InHospital);
        ...
        WHEN("emit addStatus-Event RestInHospital") {
            app.emit_event<gameevent::CreatureAddStatusEvent>(
                entity, data::CreatureStatus::RestInHospital);
        ...
        WHEN("emit addStatus-Event Rest") {
            app.emit_event<gameevent::CreatureAddStatusEvent>(
                entity, data::CreatureStatus::Rest);
        ...
        WHEN("emit addStatus-Event Training") {
            app.emit_event<gameevent::CreatureAddStatusEvent>(
                entity, data::CreatureStatus::Training);
