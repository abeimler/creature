...
MakeCreatureEvolutionHelper::make_CreatureData() {
...
MakeCreatureEvolutionHelper::make_CreatureProgressTimers() {
...
MakeCreatureEvolutionHelper::make_BattlerStatuses() {
...
MakeCreatureEvolutionHelper::make_BattlerBattleState() {
...
MakeCreatureEvolutionHelper::make_BattlerResists() {
...
MakeCreatureEvolutionHelper::make_CreatureBattler() {
...
MakeCreatureEvolutionHelper::make_CreatureBattlerGene() {
...
MakeCreatureEvolutionHelper::make_CreatureGene() {
    ...
    perevolution.needsleepinpercent =
        CreatureTestEvolutionEgg::NEEDSLEEPINPERCENT;
    perevolution.needrestinhospitalinpercent =
        CreatureTestEvolutionEgg::NEEDRESTINHOSPITALINPERCENT;
...
MakeCreatureEvolutionHelper::make_CreatureMemory() {
...
MakeCreatureEvolutionHelper::make_CreaturePersonality() {
...
MakeCreatureEvolutionHelper::make_CreatureHunger() {
...
MakeCreatureEvolutionHelper::make_CreatureEvolve() {
...
MakeCreatureEvolutionHelper::make_CreatureSleep() {
...
MakeCreatureEvolutionHelper::make_CreatureTraining() {
...
MakeCreatureEvolutionHelper::make_CreatureBodilyState() {
...
MakeCreatureEvolutionHelper::make_CreatureBody() {
...
MakeCreatureEvolutionHelper::make_CreaturePsyche() {
...
MakeCreatureEvolutionHelper::make_CreatureLife() {
...
gameentity::Entity MakeCreatureEvolutionHelper::create_Entity_Creature(
...
gameentity::Entity
MakeCreatureEvolutionHelper::create_Entity_CreatureAllWaitTime(
...
gameentity::Entity
MakeCreatureEvolutionHelper::create_Entity_CreatureAllWaitTime_Starvation(
    gameentity::EntityManager& entities, std::chrono::milliseconds waittime) {
