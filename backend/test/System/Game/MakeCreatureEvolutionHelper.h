...
class MakeCreatureEvolutionHelper {
    ...
    static gamecomp::CreatureDataComponent
    make_CreatureData() {
    ...
    static gamecomp::BattlerStatusesComponent
    make_BattlerStatuses() {
    ...
    static gamecomp::BattlerResistsComponent
    make_BattlerResists() {
    ...
    static gamecomp::CreatureBattlerComponent
    make_CreatureBattler() {
    ...
    static gamecomp::CreatureGeneComponent
    make_CreatureGene() {
    ...
    static gamecomp::CreatureMemoryComponent
    make_CreatureMemory() {
    ...
    static gamecomp::CreatureHungerComponent
    make_CreatureHunger() {
    ...
    static gamecomp::CreatureEvolveComponent
    make_CreatureEvolve() {
    ...
    static gamecomp::CreatureSleepComponent
    make_CreatureSleep() {
    ...
    static gamecomp::CreatureBodyComponent
    make_CreatureBody() {
    ...
    static gamecomp::CreaturePsycheComponent
    make_CreaturePsyche() {
    ...
    static gamecomp::CreatureLifeComponent
    make_CreatureLife() {
    ...
    create_Entity_CreatureAllWaitTime(
