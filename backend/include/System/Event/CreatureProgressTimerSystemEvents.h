#ifndef SYSTEM_GAME_CREATUREPROGRESSTIMERSYSTEMEVENTS_H_
#define SYSTEM_GAME_CREATUREPROGRESSTIMERSYSTEMEVENTS_H_
...
#endif // SYSTEM_GAME_CREATUREPROGRESSTIMERSYSTEMEVENTS_H_
