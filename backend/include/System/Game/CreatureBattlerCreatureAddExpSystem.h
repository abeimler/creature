#ifndef SYSTEM_GAME_CREATUREBATTLERCREATUREADDEXPSYSTEM_H_
#define SYSTEM_GAME_CREATUREBATTLERCREATUREADDEXPSYSTEM_H_
...
#endif // SYSTEM_GAME_CREATUREBATTLERCREATUREADDEXPSYSTEM_H_
