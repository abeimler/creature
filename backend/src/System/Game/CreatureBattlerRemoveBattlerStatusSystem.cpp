...
CreatureBattlerRemoveBattlerStatusSystem::CreatureBattlerRemoveBattlerStatusSystem(gameentity::DataManager& datamanager)
    : datamanager_(datamanager) 
{}

void CreatureBattlerRemoveBattlerStatusSystem::sortBattlerStatuses(std::vector<std::string>& statuses_name) {
...
void CreatureBattlerRemoveBattlerStatusSystem::removeBattlerStatus(const gameevent::CreatureRemoveBattlerStatusEvent& event, Component<gamecomp::BattlerStatusesComponent>& battlerstatuses){
...
void CreatureBattlerRemoveBattlerStatusSystem::removeStartBattlerStatusTurn(const gameevent::CreatureRemoveBattlerStatusEvent& event, Component<gamecomp::BattlerStatusesComponent>& battlerstatuses){
    const data::BattlerStatus& removestatus = event.removestatus;
    std::string removestatus_name = removestatus.getName();

    auto remove_startstatusturn_func = [removestatus_name](const gamecomp::BattlerStatusTurn& startstatusturn){
...
void CreatureBattlerRemoveBattlerStatusSystem::update(const gameevent::CreatureRemoveBattlerStatusEvent& event, EntityManager& entities, EventBus& events, TimeDelta dt) {
