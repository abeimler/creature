...
git subtree add --prefix backend/lib/benchpress https://github.com/abeimler/benchpress master --squash 
...
git subtree add --prefix backend/lib/eventpp https://github.com/abeimler/eventpp  master --squash 

git subtree add --prefix tools/makedata/lib/cxxopts https://github.com/jarro2783/cxxopts master --squash 
